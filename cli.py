...
def main():
    ...
    parser.add_argument('-b', '--brand', default='/work/brands/ee', help='Which brand to compile')
    ...
    parser.add_argument('--clean-cache', type=int, nargs='?', const=30,
    ...
    render = load_brand_config(args.brand)
