...
def load_book_config(book_dir, render: Config):
    ...
    if render is not None:
        content = render.replace(content)
            ...
            if end_pos != -1:
                ...
                if isinstance(metadata, dict) and 'book' in metadata:
                    ...
                    config = {
                        ...
                        'subject': book_config.get('subject',
                                                   book_config.get('description', metadata.get('description', ''))),
                        ...
                        'cover_config': {
                            ...
                            'title_text': book_config.get('cover_title_text',
                                                          book_config.get('title', metadata.get('title', 'Book'))),
