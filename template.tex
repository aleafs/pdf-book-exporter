...
\IfFontExistsTF{Source Han Mono SC}{
    \setmonofont{Source Han Mono SC}[Scale=1.0,Renderer=HarfBuzz]
    \newfontfamily\codefont{Source Han Mono SC}[Scale=1.0,Renderer=HarfBuzz]
    \typeout{Set monospace font to Source Han Mono SC for CJK code support}
}{
    \IfFontExistsTF{Source Han Sans SC}{
        \setmonofont{Source Han Sans SC}[Scale=1.0,Renderer=HarfBuzz]
        \newfontfamily\codefont{Source Han Sans SC}[Scale=1.0,Renderer=HarfBuzz]
        \typeout{Set monospace font to Source Han Sans SC for CJK support (fallback)}
    }{
        \IfFontExistsTF{PingFang SC}{
            \setmonofont{PingFang SC}[Scale=1.0,Renderer=HarfBuzz]
            \newfontfamily\codefont{PingFang SC}[Scale=1.0,Renderer=HarfBuzz]
            ...
            \IfFontExistsTF{JetBrains Mono}{
                ...
                \newfontfamily\codefont{JetBrains Mono}[Scale=1.0,Renderer=HarfBuzz]
                ...
                \IfFontExistsTF{Fira Code}{
                    ...
                    \newfontfamily\codefont{Fira Code}[Scale=1.0,Renderer=HarfBuzz]
                }{
                    \setmonofont{Menlo}[Scale=1.0,Renderer=HarfBuzz]
                    \newfontfamily\codefont{Menlo}[Scale=1.0,Renderer=HarfBuzz]
                }
            }
        }
    }
...
% Use SourceHanMono for proper monospace code display with CJK support
\IfFontExistsTF{Source Han Mono SC}{
    \setmonofont{Source Han Mono SC}[Scale=1.0]
    \newfontfamily\codefont{Source Han Mono SC}[Scale=1.0]
    \typeout{Set monospace font to Source Han Mono SC for CJK code support}
}{
    \IfFontExistsTF{Source Han Sans SC}{
        \setmonofont{Source Han Sans SC}[Scale=1.0]
        \newfontfamily\codefont{Source Han Sans SC}[Scale=1.0]
        \typeout{Set monospace font to Source Han Sans SC for CJK support (fallback)}
    }{
        \IfFontExistsTF{PingFang SC}{
            \setmonofont{PingFang SC}[Scale=1.0]
            \newfontfamily\codefont{PingFang SC}[Scale=1.0]
            \typeout{Set monospace font to PingFang SC (macOS fallback with CJK)}
        }{
            \IfFontExistsTF{JetBrains Mono}{
                \setmonofont{JetBrains Mono}[
                ...
                \newfontfamily\codefont{JetBrains Mono}[Scale=1.0]
                \typeout{Warning: Using JetBrains Mono - CJK characters may not display properly}
            }{
                \IfFontExistsTF{Fira Code}{
                    \setmonofont{Fira Code}[
                    ...
                    \newfontfamily\codefont{Fira Code}[Scale=1.0]
                }{
                    \setmonofont{Menlo}[Scale=1.0]
                    \newfontfamily\codefont{Menlo}[Scale=1.0]
                }
            }
        }
    }
...
\newcommand{\mytitlepage}{
    ...
    \hspace{0pt}
    \begin{center}
    {\fontsize{36}{1} \textbf{$title$} \par}
    \vspace{480pt}
    $if(author)$
    {\normalsize $author$\par}
    $endif$
    \vspace{15pt}
    {\normalsize 修订时间: {\today} \par}
    \vfill
    \end{center}
    \newpage
    \setcounter{page}{1}
